...
st.set_page_config(page_title="Night City History", layout="centered")
...
def main():
    ...
    selected_chapter = st.sidebar.radio("History of Night City:", options=list(lore_chapters.keys()))
    
    # Rendered inside a scrollable div
    st.markdown(f'''
        <div class="terminal-window">
            {lore_chapters[selected_chapter]}
        </div>
    ''', unsafe_allow_html=True)
    
    st.caption("CONNECTION SECURE // SCROLL ENABLED // RAJDHANI FONT // MADE BY AÑON")
